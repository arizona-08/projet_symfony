 ...
 */
final class Version20250116141110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE config (id SERIAL NOT NULL, client_id INT DEFAULT NULL, vehicle_id INT NOT NULL, kit_id INT NOT NULL, PRIMARY KEY(id))');
